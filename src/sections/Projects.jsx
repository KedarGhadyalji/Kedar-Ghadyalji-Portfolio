  ...
  return (
    <section id="projects" className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
          ...
          {projects.map((project, idx) => (
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-video">
                ...
                {/* Hover Blur & Button Overlay */}
                <div className="absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 group-hover:bg-black/20 transition-all duration-300">
                  <a
                    href={project.github}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-4 rounded-full glass hover:bg-primary hover:text-primary-foreground transition-all transform translate-y-4 group-hover:translate-y-0 duration-300 shadow-2xl"
                  >
        ...
        {/* View All CTA */}
        <div className="text-center mt-20 animate-fade-in animation-delay-500">
          <a
