/**
 * What: procedurally generates a pixel-art dirt "stalactite" strip hung from
 * the underside of the dirt footer into the cave scene below it — a
 * textured dirt shelf with short tapering nubs, tiling seamlessly at any
 * width. Purely decorative (aria-hidden, pointer-events-none).
 * Data from: n/a — the pattern is generated at module load time with a
 * seeded PRNG (mulberry32) so it looks random but never reshuffles between
 * renders.
 * Used by: src/App.jsx, rendered once at the top of the home-only
 * post-footer cave section.
 */
