/**
 * What: site navbar — logo, desktop nav links, and (below 768px) a
 * full-screen "pause menu" overlay with nav links, social icons, and a
 * resume link (the mobile equivalents of the desktop Footer's content).
 * Data from: src/data/siteConfig.js (navLinks, brand, socialMedia,
 * contactInfo).
 * Used by: src/App.jsx.
 */
