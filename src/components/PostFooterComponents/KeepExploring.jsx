/**
 * What: closing "03" band of the home post-footer — a centered contact CTA,
 * then a row of compact navigation cards to the site's other destinations.
 * Data from: src/data/home.js (contactBand, keepExploring).
...
const KeepExploring = () => (
  <section className="mb-10">
    ...
    <div className="mb-10 text-center">
      <h2 className="text-3xl font-bold text-white sm:text-4xl pixel-shadow">
        {contactBand.heading}
      </h2>
    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {keepExploring.cards.map((card) => {
        const IconComponent = card.logo; // may be undefined for a given card
        ...
        return (
          ...
          >
            {/* Logo and Title in the same row layout */}
            <div className="flex items-center gap-3 mb-2">
              {IconComponent && (
                <div className="text-[#5ce1e6] transition-colors duration-200 group-hover:text-black flex-shrink-0">
            ...
            <p className="mt-1 flex-1 font-source-code-pro text-sm leading-snug text-white/70 transition-colors duration-200 group-hover:text-black/80">
              {card.description}
            </p>
